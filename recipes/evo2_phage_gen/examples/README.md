...
| `accessory_gene_diversification` (`reward_external_accessory_gene_diversification`) | Missing/invalid evidence or no called proteins.                                                                                                                           | Complete novel K or X with K complete or absent, within the two-type copy budget.                                                                                              | K alone scores 0.50; K loss alone 0.75. Partial X earns graded credit, favoring either K endpoint; repeated types and excess accessory mass reduce the score. Partial core ORFs cannot count as extras. See the [K/X surface and family definitions](../configs/accessory_genes.md). This RL objective adds no final acceptance filter.                                                                                                                                                                                                                                                                                                                                                                                                                         |
