...
full-credit band sits inside the separate 5,306–5,493-nt hard acceptance interval. For the circular
...
| `genome_length` (`reward_genome_length`)     | Length at or below 3,000 nt, or at or above 5,426 nt.                                                                  | 5,359–5,391 nt inclusive.                                                                                                                  | Ramp linearly from 0 to 1 over 3,000–5,359 nt and from 1 to 0 over 5,391–5,426 nt. The broad lower taper is shaping credit for initially short rollouts, not acceptance: the independent hard gate remains 5,306–5,493 nt. Default no-EOD caps are 5,436/5,444 nt and therefore receive zero length credit. Exact FASTA lengths for 155 same-capsid Sinsheimervirus genomes span 5,339–5,388 nt (p5 5,359; median/reference 5,386); INPHARED's rounded kilobase field is not used. PhiX has no terminal repeat, so deposited and packaged lengths are identical. |
