...
A September 14 offline replay of the same 96 generated genomes with the current scorer and
MMseqs revision linked above measured the following absolute synteny-score changes. Pools
