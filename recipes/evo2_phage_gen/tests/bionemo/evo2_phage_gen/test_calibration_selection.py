    ...
    scored = pd.DataFrame(
        {
            ...
            "reward_external_core_gene_ordered_conservation": [0.7, 0.1],
            "reward_gene_a_origin": [0.6, 0.2],
            "reward_external_accessory_gene_diversification": [0.5, 1.0],
            ...
            "core_gene_ordered_conservation_measurement_available": [1.0, 1.0],
            "smooth_reference_measurement_available": [1.0, 1.0],
            "accessory_gene_diversification_measurement_available": [1.0, 1.0],
