...
# This file is copied from: recipes/evo2_megatron/src/bionemo/evo2/data/megatron/hyena/evo2_dataset.py
...
class Evo2Dataset(GPTDataset):
    ...
    def mask_phylogenetic_tags(
        ...
        Args:
            ...
            max_tag_len (int): When the "tag" state is longer than this, we assume that a parsing error happened and
                it is actually not a tag. This protects against parsing errors resulting in masking large sections of DNA.
