...
# This file is copied from: recipes/evo2_megatron/src/bionemo/evo2/models/megatron/hyena/hyena_utils.py
...
def _get_inverse_zigzag_indices(N, device=None):  # noqa: N803
...
def all_to_all_single_fn(
    ...
    if type == "split_to_full":
        ...
        B, D, local_length = input.shape  # noqa: N806
        L = local_length * world_size  # noqa: N806
        d = D // world_size
...
class ParallelCausalDepthwiseConv1dWithState(ParallelCausalDepthwiseConv1d):
    ...
    def __init__(self, *args, **kwargs):
        """Initialize and set up cached weight computation."""
    ...
    def forward(self, x, inference_context=None, _use_cp=True):  # noqa: D102
        ...
        features_BLD = rearrange(x, "b d l -> b l d").contiguous()  # noqa: N806
        u = features_BLD
